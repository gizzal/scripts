...
POL_System_TmpCreate "Photoshop"
Set_OS "win7"

# Install dependencies
POL_SetupWindow_wait "Please wait while Photoshop is installed..." "$TITLE"
...
# Get the installer
cd "$POL_System_TmpDir"
POL_Download "/home/carlos/Downloads/AdobePhotoshop19-mul.zip"
...
POL_Wine "$INSTALLER"
POL_Shortcut "Photoshop.exe" "Photoshop18"
